...
- 📸 **Snapshots** : versions automatiques du graphe
- 🤝 **Propositions** : système collaboratif avec validation
...
L'application inclut maintenant un système de propositions permettant à des utilisateurs externes de suggérer des modifications :

- **Propositions** : Ajout/modification/suppression de personnes ou relations
- **Validation** : Approbation ou rejet par l'administrateur
- **Snapshots** : Versions automatiques créées à chaque approbation
- **Historique** : Possibilité de restaurer une version antérieure

Voir [API-PROPOSITIONS.md](./API-PROPOSITIONS.md) pour la documentation complète des endpoints.
